...
set fish_color_param 5fafff
set fish_color_quote ffd700
set fish_color_redirection 00d700
...
#set fish_pager_color_prefix 18a5a6 cyan --underline
set fish_pager_color_prefix --underline ffd75f
set fish_pager_color_description bcbcbc
